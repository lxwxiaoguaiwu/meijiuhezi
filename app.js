...
App({
      ...
      fail: function (res) {
        wx.login({
          success: function (res) {
            var code = res.code;
            wx.request({
              url: 'https://api.changching.cn/api/v3/alcoholusers',
              method: 'POST',
              data: {
                js_code: code
              },
  ...
  checkScene: function (code, path, query) {
    ...
    wx.getUserInfo({
      success: res => {
        ...
        that.globalData.userInfo = userInfo
        wx.request({
          url: 'https://api.changching.cn/api/v3/alcoholusers/' + userInfo.id,
          method: 'PUT',
          data: {
            wename: res.userInfo.nickName,
            weasset: res.userInfo.avatarUrl,
  ...
  globalData: {
    baseAPI: "https://api.changching.cn/api/v3",
